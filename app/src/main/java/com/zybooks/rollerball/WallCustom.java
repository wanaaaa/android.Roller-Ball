...
public class WallCustom {

    public int WALL_SPEED = 60;
    private int mMoveDistance;
    private Rect mRect;
    private int mSurfaceWidth;
    private Paint mPaint;

    public WallCustom(int x, int y, boolean initialDirectionRight, int surfaceWidth, int surfaceHeight) {

        mSurfaceWidth = surfaceWidth;

        // Determine wall dimensions based on surface width and height
        int width = surfaceWidth / 9;
        int height = surfaceHeight / 30;
        ...
        mPaint.setColor(Color.parseColor("#4aea37"));
    }
